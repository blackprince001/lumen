...
from app.services.references import ReferenceFormatter, reference_formatter, citation_fields, _escape_bibtex
...
class TestAPA:
    ...
    def test_journal_with_volume(self):
        paper = make_paper(author="Smith, John", year="2023", journal="Nature", volume="42", pages="100-110")
        ref = reference_formatter.format_apa(paper)
...
class TestChicago:
    def test_basic(self):
        paper = make_paper(author="Smith, John", year="2023", title="A Great Paper", journal="Nature")
...
class TestIEEE:
    def test_basic(self):
        paper = make_paper(author="Smith, John", year="2023", title="Test", journal="IEEE Journal")
...
class TestBibTeX:
    def test_basic(self):
        paper = make_paper(author="Smith, John", year="2023", title="Test Paper", doi="10.1234/test")
    ...
    def test_arxiv(self):
        paper = make_paper(author="Smith, John", year="2023", title="Test", doi="arxiv:2301.12345")
        ref = reference_formatter.format_bibtex(paper)
