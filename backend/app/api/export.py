...
_FORMATTERS = {
    ...
    "chicago": reference_formatter.format_chicago,
    "ieee": reference_formatter.format_ieee,
...
async def export_citations(
    ...
    formatter = _FORMATTERS.get(request.format)
    if not formatter:
        raise HTTPException(status_code=400, detail=f"Unsupported citation format: {request.format}")
